...
\chapter{Work Plan}
\label{cha:workplan}
As it was proposed in~\ref{cha:introduction} and the title, the main purpose of this thesis is the design, simulation and optimization of \glspl{MPA} for Wi-Fi 7.
...
An initial analysis was needed to better understand the standards, techniques and multiband approaches for \gls{MPA}, this can be seen in~\ref{cha:stateoftheart}. 
